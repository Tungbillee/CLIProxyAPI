...
<template>
  <header
    class="sticky top-0 z-20 bg-dark-800 border-b border-dark-700 px-4 py-3 flex items-center justify-between flex-shrink-0"
  >
    ...
    <div class="flex items-center gap-2">
      ...
      <button
        ...
        "
        :title="
          store.sendContext ? 'Đang gửi lịch sử chat' : 'Chỉ gửi tin nhắn mới'
        "
      >
